.cran_packages = c("devtools", "dplyr", "yaml")
...
cel.dir = paste0(rawdata, manifest$rawdata_aijoe_thp_th0_th1_th2)
meta.table.dir = manifest$phenodata_aijoe_thp_th0_th1_th2
out.affybatch = paste0(workdata, manifest$affybatch_aijoe_thp_th1)
out.file = paste0(workdata, manifest$eda_prep_aijoe_thp_th1)
...
meta.table = readRDS(paste0(workdata, meta.table.dir, "aijö-thp-th0-th1-th2.Rds"))[[1]]
...
meta.table = meta.table[!grepl("th2.*", meta.table$SHORT_NAME), ]
meta.table = meta.table[!grepl("th0.*", meta.table$SHORT_NAME), ]
meta.table = droplevels(meta.table)
meta.table = meta.table[order(meta.table$HOURS), ]
