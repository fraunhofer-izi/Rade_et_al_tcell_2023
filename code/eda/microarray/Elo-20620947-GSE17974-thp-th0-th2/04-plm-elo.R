...
# obj with rawdata
affybatch = readRDS(paste0(workdata, manifest$affybatch_elo_thp_th2))

# Output paths for array/pseudo images
array.images = manifest$array_images_elo_thp_th2

plm.obj.out = paste0(workdata, manifest$plm_obj_elo_thp_th2)
plm.nuse.rle.out = paste0(workdata, manifest$plm_nuse_rle_elo_thp_th2)
