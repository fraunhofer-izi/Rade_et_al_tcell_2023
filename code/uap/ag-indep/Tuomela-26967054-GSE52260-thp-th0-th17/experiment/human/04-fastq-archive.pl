...
my $queryDIR = "/data/RNA-Seq/2018-MAVO-MCF/Tuomela-26967054-GSE52260-thp-th0-th17/Unaligned/Project_Tuomela-26967054-GSE52260-thp-th0-th17/";
...
foreach my $x (@metaData) {
    ...
    my @col = split(/\t/, $x);
    my $srrIDMeta = &trim($col[7]);
    $srrIDMeta =~ s/"//g;
    my $gsmIDMeta = &trim($col[9]);
    $gsmIDMeta =~ s/"//g;
